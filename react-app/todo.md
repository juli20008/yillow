...
remove the 2nd search box in red circile, and move the filters to hero section below the 1st search box![alt text](image-4.png)
...
This container on main page is not perfect: ![](image-5.png) adjust it to look like the one on map search page: ![alt text](image-6.png)
